...
function senAtGlance(object){
    console.log(object)
    var republicans=document.getElementById("Republican-row")
    var democrats=document.getElementById("Democrat-row")
    var independents=document.getElementById("Independent-row")
